...
/* ----------------------------------------------------------------
 * mpu9255_init_100hz
 * Configure accel ±2 g, gyro ±250 dps, DLPF=3, output @ 100 Hz.
 * Accepts WHO_AM_I = 0x73 (MPU-9255) or 0x71 (MPU-9250).
 * ---------------------------------------------------------------- */
mpu9255_status_t mpu9255_init_100hz(I2C_HandleTypeDef *hi2c, uint8_t addr7, mpu9255_cfg_t *out_cfg)
{
    ...
    /* 3) Sample rate: 1 kHz / (1 + SMPLRT_DIV) = 100 Hz → DIV = 9 */
    if (i2c_write_reg(hi2c, addr7, MPU9255_REG_SMPLRT_DIV, 9u, 50) != I2C_REG_OK)
        return MPU9255_ERR_I2C;
